// A C++ program to find kth smallest element using max heap
#include <climits>
#include <iostream>
using namespace std;
...
{
    heap_size = size;
    harr = a; // store the address of array
    int i = (heap_size - 1) / 2;
    while (i >= 0)
    {
        maxHeapify(i);
...
// index. This method assumes that the subtrees are already
// heapified
...
// Function to return kth larget element in an array
